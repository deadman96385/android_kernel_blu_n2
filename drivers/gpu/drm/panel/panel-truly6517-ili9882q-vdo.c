...
lcm_dcs_write_seq_static(ctx,0xF1,0x14);    // Tcon ESD option  1C  20210107
...
lcm_dcs_write_seq_static(ctx,0xF2,0x4A);    
...
lcm_dcs_write_seq_static(ctx,0x04,0x06);   // Vcom
...
lcm_dcs_write_seq_static(ctx,0x80,0x08);      // mipi_cmd_toggle_en (9882Q=08 / 9882K=09) 
lcm_dcs_write_seq_static(ctx,0xB6,0x30);   

// Gamma Register
lcm_dcs_write_seq_static(ctx,0xFF,0x98,0x82,0x08);								
lcm_dcs_write_seq_static(ctx,0xE0,0x40,0x24,0xD4,0xFF,0x32,0x55,0x5D,0x80,0xA7,0xC9,0xAA,0x00,0x2E,0x58,0x80,0xEA,0xA9,0xD8,0xF4,0x16,0xFF,0x32,0x55,0x7F,0xA1,0x03,0xEC);								
lcm_dcs_write_seq_static(ctx,0xE1,0x40,0x24,0xD4,0xFF,0x32,0x55,0x5D,0x80,0xA7,0xC9,0xAA,0x00,0x2E,0x58,0x80,0xEA,0xA9,0xD8,0xF4,0x16,0xFF,0x32,0x55,0x7F,0xA1,0x03,0xEC);	
							
// OSC Auto Trim Setting
lcm_dcs_write_seq_static(ctx,0xFF,0x98,0x82,0x0B);
lcm_dcs_write_seq_static(ctx,0x9A,0x89);
lcm_dcs_write_seq_static(ctx,0x9B,0x03);
lcm_dcs_write_seq_static(ctx,0x9C,0x06);
lcm_dcs_write_seq_static(ctx,0x9D,0x06);
lcm_dcs_write_seq_static(ctx,0x9E,0xE1);
...
static int fb_notifier_callback(struct notifier_block *nb, unsigned long event, void *data){
	...
	if (fb_event && fb_event->data) {
		blank = fb_event->data;
		printk("ili9882q Notifier's event = %ld, blank:%d truly\n", event, *blank);
		switch (*blank) {
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "truly6517,ili9882q,vdo", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-truly6517-ili9882q-vdo",
		.owner = THIS_MODULE,
