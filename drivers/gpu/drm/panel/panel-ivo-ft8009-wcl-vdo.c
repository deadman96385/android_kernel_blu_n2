...
lcm_dcs_write_seq_static(ctx,0xD9,0x7C,0x7C);  //#VCOM=-2.24V 
...
//Analog Gamma 
lcm_dcs_write_seq_static(ctx,0x00,0x00);
lcm_dcs_write_seq_static(ctx,0xE1,0x0A,0x12,0x1F,0x28,0x31,0x38,0x43,0x4E,0x51,0x5F,0x62,0x75,0x8E,0x7B,0x7C,0x72);
lcm_dcs_write_seq_static(ctx,0x00,0x10);
lcm_dcs_write_seq_static(ctx,0xE1,0x6D,0x64,0x59,0x52,0x4C,0x40,0x30,0x0F);

lcm_dcs_write_seq_static(ctx,0x00,0x00);
lcm_dcs_write_seq_static(ctx,0xE2,0x00,0x12,0x1F,0x28,0x31,0x38,0x43,0x4E,0x51,0x5F,0x62,0x75,0x8E,0x7B,0x7C,0x72);
lcm_dcs_write_seq_static(ctx,0x00,0x10);
lcm_dcs_write_seq_static(ctx,0xE2,0x6D,0x64,0x59,0x52,0x4C,0x40,0x30,0x0F);
...
lcm_dcs_write_seq_static(ctx,0xC2,0x8F,0x09,0x00,0x98); 

lcm_dcs_write_seq_static(ctx,0x00,0x84);//VST2
lcm_dcs_write_seq_static(ctx,0xC2,0x8E,0x09,0x00,0x98); 

lcm_dcs_write_seq_static(ctx,0x00,0x88);//VST3
lcm_dcs_write_seq_static(ctx,0xC2,0x8D,0x09,0x00,0x98); 

lcm_dcs_write_seq_static(ctx,0x00,0x8C);//VST4
lcm_dcs_write_seq_static(ctx,0xC2,0x8C,0x09,0x00,0x98); 
...
lcm_dcs_write_seq_static(ctx,0x00,0x80);
lcm_dcs_write_seq_static(ctx,0xC0,0x00,0xBC,0x00,0xF0,0x00,0x0A); 

lcm_dcs_write_seq_static(ctx,0x00,0x90);
lcm_dcs_write_seq_static(ctx,0xC0,0x00,0xBC,0x00,0xF0,0x00,0x0A); 

lcm_dcs_write_seq_static(ctx,0x00,0xB0);
lcm_dcs_write_seq_static(ctx,0xC0,0x00,0xBC,0x00,0xF0,0x0A); 
...
lcm_dcs_write_seq_static(ctx,0xCE,0x00,0x0A,0x01,0x01,0x00,0xCD,0x01); 

lcm_dcs_write_seq_static(ctx,0x00,0xE6);
lcm_dcs_write_seq_static(ctx,0xCE,0x00,0x71); 
