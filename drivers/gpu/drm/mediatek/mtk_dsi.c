...
//prize add by wangfei for first suspend reinit 6382 20211011 start
#ifdef CONFIG_MTK_MT6382_BDG
	if(1 == get_mt6382_first_suspend_stat())
	{
		bdg_common_init(DISP_BDG_DSI0, dsi, NULL);
	}
#endif
//prize add by wangfei for first suspend reinit 6382 20211011 end
