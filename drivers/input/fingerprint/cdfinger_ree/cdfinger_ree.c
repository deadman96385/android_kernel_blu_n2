...
static int cdfinger_driver_status = 0;
static ssize_t cdfinger_chip_status_show(struct device *dev,
								   struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%d\n", cdfinger_driver_status);
}
...
static DEVICE_ATTR(chip_status, S_IRUGO | S_IWUSR, cdfinger_chip_status_show, NULL);
