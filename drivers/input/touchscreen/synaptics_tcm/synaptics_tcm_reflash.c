...
#define FW_IMAGE_NAME "reflash_firmware.img"
...
//  sprintf(current_tp_info.chip,"S3909_FW:0x%02x_0x%02x", tcm_hcd->app_info.customer_config_id[5],tcm_hcd->app_info.customer_config_id[6]);
    sprintf(current_tp_info.chip,"S3909_FW:0x%c%c", tcm_hcd->app_info.customer_config_id[5],tcm_hcd->app_info.customer_config_id[6]);
