...
// prize baibo for ata test begin
#define TOUCH_INPUT_NAME "mtk-tpd"
// prize baibo for ata test end
...
struct syna_tcm_hcd {
	...
	bool wakeup_click_enabled;
	bool wakeup_fod_enabled;
	bool open_icon;
	bool report_click_show_icon;
...
int tcm_gesture_click_set(u8 value);
