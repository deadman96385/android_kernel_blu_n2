...
/*prize-20201210-zhaopengge for TP info start */
#if 0//defined(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../misc/mediatek/hardware_info/hardware_info.h"
extern struct hardware_info current_tp_info;
#endif
/*prize-20201210-zhaopengge for TP info end */
...
/*prize-20201210-zhaopengge for TP info start */
#if 0//defined(CONFIG_PRIZE_HARDWARE_INFO)
	sprintf(current_tp_info.chip,"ILI9882,FW_VER:%d.%d.%d.%d",buf[1],buf[2],buf[3],buf[4]);
	sprintf(current_tp_info.id,"0x%06x", ilits->chip->pid >> 8);
	strcpy(current_tp_info.vendor,"ILITEK");
	strcpy(current_tp_info.more,"720*1440");
#endif	
/*prize-20201210-zhaopengge for TP info end */
