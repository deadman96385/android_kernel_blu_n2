...
#define AW99703_DRIVER_VERSION "v1.1.0"
...
static int aw99703_gpio_init(struct aw99703_data *drvdata)
{
	...
	if (gpio_is_valid(drvdata->hwen_gpio)) {
		...
		/* Prize HanJiuping deleted 20210622 start */
		/* Keep backlight ON, DO NOT shut down the IC */
		/* ret = gpio_direction_output(drvdata->hwen_gpio, 0); */
		/* Prize HanJiuping deleted 20210622 end */
			...
			const struct i2c_device_id *id)
{
	...
	drvdata->enable = false;     //prize modify by wangfei for init backlight
