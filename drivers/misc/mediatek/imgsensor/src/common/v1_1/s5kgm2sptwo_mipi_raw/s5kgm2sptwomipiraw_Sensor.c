...
#include "s5kgm2sptwomipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM2SPTWO_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = 
{
 ...
 //{ 8000, 6000,	 160,  	840, 7680, 4320, 1920, 1080, 0,	0, 1920, 1080, 0, 0, 1920, 1080}, //hight speed video
...
static kal_uint32 return_sensor_id(void)
{
	...
	printk("s5kgm2sptwo otp module_id =0x%x \n",module_id);
	if ((0x04 == module_id)||(0x02 == module_id)) {
	...
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
	   ...
	   case SENSOR_FEATURE_SET_PDAF:
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			//S5KGM2SPTWO_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
        /******************** PDAF END   <<< *********/
...
UINT32 S5KGM2SPTWO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	S5KGM2SPTWO_MIPI_RAW_SensorInit	*/
