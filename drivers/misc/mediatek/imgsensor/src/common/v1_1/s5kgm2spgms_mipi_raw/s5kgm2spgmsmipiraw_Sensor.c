...
#include "s5kgm2spgmsmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM2SPGMS_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	printk("s5kgm2spgms otp module_id =0x%x \n",module_id);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		...
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 9900000;   //3000000   
		break;
	   ...
	   case SENSOR_FEATURE_SET_PDAF:
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			//S5KGM2SPGMS_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
        /******************** PDAF END   <<< *********/
...
UINT32 S5KGM2SPGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	S5KGM2SPGMS_MIPI_RAW_SensorInit	*/
