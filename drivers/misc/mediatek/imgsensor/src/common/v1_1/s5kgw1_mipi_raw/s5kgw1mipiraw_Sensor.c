...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
  ...
  { 9280, 6944, 800,  1312,  7680, 4320, 1920,  1080,   0,	0, 1920,  1080, 	 0, 0, 1280,  720}, //high speed video_720p
  { 9280, 6944,	 0,    0,  9280, 6944, 2320, 1736,   0,	0, 2320, 1736, 	 0, 0, 1280, 720},/* slim video*/
  { 9280, 6944,	 0,    0,  9280, 6944, 4640, 3472,   0,	0, 4640, 3472, 	 0, 0, 3744, 2808}, // custom1 
};
...
static kal_uint16 addr_data_pair_init_gw1_A1[] = {
	0x6028,0x2001,  //Global_nonHDR 
	0x602A,0xCF94,
	0x6F12,0x0000,
	0x6F12,0x0000,
	0x6F12,0x0000,
...
////for EVT0.2 , modified by 20210512, if 0x0002 register value is 0xA201, e.g:if (read_cmos_sensor_8(0x0002) = 0xA2)
static kal_uint16 addr_data_pair_init_gw1_A2[] = {
...
////for EVT0.1 , modified by 20210512,if 0x0002 register value is 0xA101
////for EVT0.2 , modified by 20210512,if 0x0002 register value is 0xA201
static void sensor_init(void)
{

  kal_uint16 revision = 0;
 ...
 revision = read_cmos_sensor(0x0002);
 printk("zzh_s5kgw1 revision: 0x%x, sensor id: 0x%x\n", revision);
 if (revision == 0xA1)
 {
  table_write_cmos_sensor(addr_data_pair_init_gw1_A1,
      sizeof(addr_data_pair_init_gw1_A1) / sizeof(kal_uint16));
 }
 else
	 
	 {
		 
	  table_write_cmos_sensor(addr_data_pair_init_gw1_A2,
      sizeof(addr_data_pair_init_gw1_A2) / sizeof(kal_uint16));	 
