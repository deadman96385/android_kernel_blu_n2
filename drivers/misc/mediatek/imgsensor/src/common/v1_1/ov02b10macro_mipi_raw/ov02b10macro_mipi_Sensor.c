...
#define MULTI_WRITE 1 // prize add  by zhuzhengjiang 20200706
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10MACRO_SENSOR_ID,
	...
	.min_gain_iso = 100,
	.gain_step = 1,
	.gain_type = 1, //Sony, type 0;OV, type 1;Samsung, type2;Hynix, type 3;GC, type4 FAQ22915
...
// prize add  by zhuzhengjiang 20200706 start
#if MULTI_WRITE
#define I2C_BUFFER_LEN 208
#else
#define I2C_BUFFER_LEN 2
#endif

#if MULTI_WRITE
static kal_uint16 ov02b10_table_write_cmos_sensor(
...
#endif
// prize add by zhuzhengjiang 20200706 end
...
// prize add by zhuzhengjiang 20200706 start
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov02b10[] = 	{
      0xfc, 0x01,
	0xfd, 0x00,
	0xfd, 0x00,
	0x24, 0x02,
...
static void sensor_init(void)
{
	...
	/* Reset */
#if MULTI_WRITE // prize add  by zhuzhengjiang 20200706
	ov02b10_table_write_cmos_sensor(
		addr_data_pair_init_ov02b10,
		sizeof(addr_data_pair_init_ov02b10) / sizeof(kal_uint16));
#else
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (1){//if(curr_sensor_id  == 3 || curr_sensor_id  == 2) {
			...
			do {
				...
				*sensor_id = return_sensor_id()+2;
				if (*sensor_id == imgsensor_info.sensor_id) {
					printk("OV02B10macro i2c write id: 0x%x, sensor id: 0x%x\n",
						imgsensor.i2c_write_id, *sensor_id);
					return ERROR_NONE;
				}
				printk("OV02B10macro Read sensor id fail, write id: 0x%x, id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				retry_cnt--;
			} while (retry_cnt > 0);
			i++;
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		...
		write_cmos_sensor(0xfd, 0x03);
		write_cmos_sensor(0xc2, 0x00);
		mdelay(80);// prize modify by zhuzhengjiang 20200815
	}
	//mdelay(40); // prize modify by zhuzhengjiang 20200706
	return ERROR_NONE;
}
