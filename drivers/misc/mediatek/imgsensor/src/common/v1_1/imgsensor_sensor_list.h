...
UINT32 IMX481GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 IMX458_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*OV*/
...
UINT32 OV02B10MacroMIPISensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);	//prize add by huarui
/*S5K*/
...
UINT32 S5KGW1GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K3P9GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5KGD1SPGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 OV64B404CELL_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);// Prize add by zhuzhengjiang for compatibility of remosaic sensor
