...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.mipi_pixel_rate = 432000000,  //1080x4lane/10bit
	...
	.hs_video = {
		...
		.startx = 0,
		.starty = 0,
        .grabwindow_width = 1048,
        .grabwindow_height = 776,
		.mipi_data_lp2hs_settle_dc = 85,	/* unit , ns */
		.mipi_pixel_rate = 432000000,
		.max_framerate = 1200,
	},
	.slim_video = {
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 2096,	/* 1280, */
		.grabwindow_height = 1552,	/* 720, */
		.mipi_data_lp2hs_settle_dc = 85,	/* unit , ns */
		.mipi_pixel_rate = 432000000,
		.max_framerate = 300,
	},
	...
	.i2c_addr_table = {0x5A, 0x20 ,0xff},	/* 0x5a & 0x20 */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 4192, 3104,  174,  108, 2096, 1552, 2096, 1552, 0000, 0000, 1048,  776, 000, 0000, 1048,  776}, //hight speed video 
	{ 4192, 3104,  000,  000, 2096, 1552, 2096, 1552, 0000, 0000, 2096, 1552, 000, 0000, 2096, 1552},
...
//prize add by yaozhipeng 20201103 start
...
/********************************************************************************************************************/
/* $MIPI[Width:2096,Height:1552,Format:RAW10,Lane:4,ErrorCheck:0,
...
/********************************************************************************************************************/
/* $MIPI[Width:1280,Height:720,Format:RAW10,Lane:4,ErrorCheck:0,
 * PolarityData:0,PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
 */
...
//prize add by yaozhipeng 20201103 end
