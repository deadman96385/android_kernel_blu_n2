 ...
 *=====================================================
 ************************************************************************/
#define PFX "IMX481GMS_camera_sensor"
...
#include "imx481gmsmipiraw_Sensor.h"
...
static kal_uint32 return_mod_id_from_otp(void)
{
	...
	printk("IMX481GMS read otp MID 0x%x\n",mid_val);
...
#endif
static kal_uint16 imx481gms_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx481gms[] = {
...
{
	pr_debug("02E\n");
	imx481gms_table_write_cmos_sensor(addr_data_pair_init_imx481gms,
	    sizeof(addr_data_pair_init_imx481gms)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_imx481gms[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481gms_table_write_cmos_sensor(
	addr_data_pair_preview_imx481gms,
	sizeof(addr_data_pair_preview_imx481gms) / sizeof(kal_uint16));
} /* preview_setting */


kal_uint16 addr_data_pair_capture_imx481gms[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481gms_table_write_cmos_sensor(addr_data_pair_capture_imx481gms,
		sizeof(addr_data_pair_capture_imx481gms) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_video_imx481gms[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	pr_debug("E! %s:%d\n", __func__, currefps);
	imx481gms_table_write_cmos_sensor(addr_data_pair_video_imx481gms,
		sizeof(addr_data_pair_video_imx481gms) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_imx481gms[] = {	/*720 120fps */
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481gms_table_write_cmos_sensor(addr_data_pair_hs_video_imx481gms,
		sizeof(addr_data_pair_hs_video_imx481gms) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_imx481gms[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481gms_table_write_cmos_sensor(addr_data_pair_slim_video_imx481gms,
	    sizeof(addr_data_pair_slim_video_imx481gms) / sizeof(kal_uint16));
}
...
static kal_uint32 imx481gms_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
static void check_stream_is_on(void)
{
	...
	for (i = 0; i < timeout; i++) {
		...
		if (framecnt != 0xFF) {
			pr_debug("IMX481GMS stream is on, %d \\n", framecnt);
			break;
		}
		pr_debug("IMX481GMS stream is not on %d \\n", framecnt);
		mdelay(1);
	}
}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6080000;   //3000000   
		break;
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx481gms_awb_gain(pSetSensorAWB);
		break;
...
UINT32 IMX481GMS_MIPI_RAW_SensorInit(
