...
#define PFX "s5k4h7yxtwo_camera_sensor"
#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __func__, ##args)


static DEFINE_SPINLOCK(imgsensor_drv_lock);

extern bool otp_4h7two_update_otp(void);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YXTWO_SENSOR_ID,
...
kal_uint16 otp_4h7two_read_cmos_sensor(kal_uint32 addr)
{
...
void otp_4h7two_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para)
{
	write_cmos_sensor_8(addr, para);
}
unsigned char S5K4H7TWO_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7TWO_write_cmos_sensor(u16 addr, u32 para)
{
    char pusendcmd[3] = {(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF)};
...
static kal_uint32 return_sensor_id(void)
{
	...
	get_byte = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001)+2);
	return get_byte;
...
UINT32 S5K4H7YXTWO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
