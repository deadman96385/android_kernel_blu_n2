 ...
 * Filename:
 * ---------
 *   OV64B404CELL_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov64b404cellmipiraw_Sensor.h"
#include "ov64b404cell_Sensor_setting.h"
#define PFX "OV64B404CELL_camera_sensor"
...
#define  OV64B404CELL_MIRROR_FLIP_ENABLE 1
#define  REMOSAIC_SUPPORT 1  // prize add by zhuzhengjiang for disable remosaic 
#define EEPROM_READ_ID  0xA4
static DEFINE_SPINLOCK(imgsensor_drv_lock);
#if REMOSAIC_SUPPORT
#define DATA_XTALK_SIZE  288
#define DATA_PDC_SIZE    732
char xtalk_data [DATA_XTALK_SIZE];
char pdc_data [DATA_PDC_SIZE];
static char flag_calibration = 0;
#endif

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B404CELL_SENSOR_ID,
...
#if OV64B404CELL_MIRROR_FLIP_ENABLE
    	#if REMOSAIC_SUPPORT
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 9248,  6944,784,1312, 7680,  4320,  3840,  2160,  0000,  0000,  3840,  2160,  0,  0,  3840,  2160},	/*custom2 4K@60fps*/
#if REMOSAIC_SUPPORT
...
static kal_uint16 ov64b404cell_table_write_cmos_sensor(
...
#if REMOSAIC_SUPPORT
	static kal_uint16 ov64b40_table_write_calibration(
					kal_uint16 offset,char *para, kal_uint32 len)
	{
		char puSendCmd[I2C_BUFFER_LEN];
		kal_uint32 tosend, IDX;
		kal_uint16 addr = 0, addr_last = 0;
		char data;
...
static int read_eeprom(int offset, char *data, kal_uint32 size)
{
	int i = 0, addr = offset;
	int sum = 0;
	...
	for (i = 0; i < size; i++) {
		...
		//printk("get addr:0x%x the value is :0x%x",addr,data[i]);
		addr++;
		sum = sum + data[i];
	}
	printk("sum = %d",sum);
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("sensor_init\n");
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_init_ov64b404cell,
		sizeof(addr_data_pair_init_ov64b404cell) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_preview_ov64b404cell,
		sizeof(addr_data_pair_preview_ov64b404cell) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_capture_ov64b404cell,
		sizeof(addr_data_pair_capture_ov64b404cell) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_video_ov64b404cell,
		sizeof(addr_data_pair_video_ov64b404cell) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov64b404cell,
		sizeof(addr_data_pair_hs_video_ov64b404cell) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov64b404cell_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov64b404cell,
		sizeof(addr_data_pair_slim_video_ov64b404cell) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("E\n");
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_custom1_ov64b404cell,
		sizeof(addr_data_pair_custom1_ov64b404cell) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_custom2_ov64b404cell,
		sizeof(addr_data_pair_custom2_ov64b404cell) / sizeof(kal_uint16));
}	/*	custom2_setting  */
...
static void custom3_setting(void)
{
  LOG_INF("E\n");
#if REMOSAIC_SUPPORT
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_custom3_ov64b404cell,
		sizeof(addr_data_pair_custom3_ov64b404cell) / sizeof(kal_uint16));
  if(flag_calibration & 0x03) {
	// apply pdc data
  	ov64b40_table_write_calibration(0x5F80,pdc_data,DATA_PDC_SIZE);
	write_cmos_sensor(0x5000,(read_cmos_sensor(0x5000) | 0x02)); // 0x5000[1] set to 1
  	// apply xtalk data
  	ov64b40_table_write_calibration(0X5A40,xtalk_data,DATA_XTALK_SIZE);
	write_cmos_sensor(0x5000,(read_cmos_sensor(0x5000) | 0x08));// 0x5000[3] set to 1
	write_cmos_sensor(0x5A02,(read_cmos_sensor(0x5A02) | 0x01));// 0x5A02[0] set to 1
  }
#else
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_capture_ov64b404cell,
		sizeof(addr_data_pair_capture_ov64b404cell) / sizeof(kal_uint16));
#endif
}	/*	custom3_setting  */
static void custom4_setting(void)
{
  LOG_INF("E\n");
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_custom4_ov64b404cell,
		sizeof(addr_data_pair_custom4_ov64b404cell) / sizeof(kal_uint16));
}	/*	custom4_setting  */
static void custom5_setting(void)
{
  LOG_INF("E\n");
  ov64b404cell_table_write_cmos_sensor(addr_data_pair_custom5_ov64b404cell,
		sizeof(addr_data_pair_custom5_ov64b404cell) / sizeof(kal_uint16));
}	/*	custom5_setting  */
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			flag = read_eeprom(0x0F8A,&data_temp[0],1);
			if(flag) {
			    *sensor_id = *sensor_id + 1;
			    printk("otp write xtalk sucess,it is remosaic sensor \n");
			}
			else {
			    *sensor_id = 0xFFFFFFFF;
			    printk("otp not write xtalk,it is not remosaic sensor,return err \n");
			}
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				flag = read_eeprom(0x0FAE,&data_temp[0],1);
				if(flag) {
					checksum = read_eeprom(0x128B,&data_temp[0],1);
					if(checksum == (read_eeprom(0x0FAF,&pdc_data[0],DATA_PDC_SIZE) % 255 +1)) {
						flag_calibration = 0X01;
						printk("get pdc calibration data sucess \n");
					}
					else
						printk("get pdc calibration data is invalid \n");
				}
				else{
					printk("pdc calibration data is NULL \n");
				}

				// get xtalk data
				flag = read_eeprom(0x128C,&data_temp[0],1);
				if(flag) {
					checksum = read_eeprom(0x13AD,&data_temp[0],1);
					if(checksum == (read_eeprom(0x128D,&xtalk_data[0],DATA_XTALK_SIZE) % 255 +1 )) {
						flag_calibration = flag_calibration | 0x02;
						printk("get xtalk calibration data sucess \n");
					}
					else
						printk("xtalk calibration data is invalid \n");
				}
				else{
					printk("xtalk calibration data is NULL \n");
				}
				//printk("flag_calibration =%d \n",flag_calibration);
				#endif
				return ERROR_NONE;
			}
			retry--;
