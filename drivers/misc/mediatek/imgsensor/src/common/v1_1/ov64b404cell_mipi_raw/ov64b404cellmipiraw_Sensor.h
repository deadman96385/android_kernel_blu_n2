 ...
 * Filename:
 * ---------
 *	 OV64B404CELL_REAR_REARmipi_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _OV64B404CELL_REAR_MIPI_SENSOR_H
#define _OV64B404CELL_REAR_MIPI_SENSOR_H
...
typedef struct imgsensor_info_struct {
	...
	kal_uint8  mipi_hs_taril_value; // prize add by zhuzhengjiang for mipi hs_trail_value 20210619
