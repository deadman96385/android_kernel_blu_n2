...
#include "ov48b2qmipiraw_Setting.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV48B2Q_SENSOR_ID,
    .checksum_value = 0xDBB0089B,
    .pre = {
        .pclk = 115200000,
        .linelength = 1056,
        .framelength = 3636,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    ...
    { 8000, 6000,    0,    0, 8000, 6000, 4000, 3000,    0,    0, 4000, 3000, 0,   0,   4000, 3000},// normal_video
    { 8000, 6000,    0,    0, 8000, 6000, 2000, 1500,   40,  210, 1920, 1080, 0,   0,   1920, 1080},// hs_video
    { 8000, 6000,    0,    0, 8000, 6000, 4000, 3000,   80,  420, 3840, 2160, 0,   0,   3840, 2160},// slim_video
    { 8000, 6000,    0,    0, 8000, 6000, 8000, 6000,    0,    0, 8000, 6000, 0,   0,   8000, 6000},// custom1
};
...
{
    pr_debug("OV48B2QMIPIRAW sensor_init E\n");
    load_init_setting();
    set_mirror_flip(imgsensor.mirror);
    pr_debug("OV48B2QMIPIRAW sensor_init X\n");
}	/* sensor_init */
