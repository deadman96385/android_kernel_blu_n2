...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		/* prize modify by linchong 20210521 for camera i2c channel start */
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_1,
		{
			...
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
/* Prize HanJiuping added 20210704 for front camera MIPI switch start */
#ifdef MIPI_SWITCH
			{IMGSENSOR_HW_PIN_MIPI_SWITCH_EN,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_MIPI_SWITCH_SEL, IMGSENSOR_HW_ID_GPIO},
#endif
/* Prize HanJiuping added 20210704 for front camera MIPI switch end */
			{IMGSENSOR_HW_PIN_NONE, IMGSENSOR_HW_ID_NONE},
		},
	},
	{
...
#ifdef MIPI_SWITCH
			{IMGSENSOR_HW_PIN_MIPI_SWITCH2_EN, IMGSENSOR_HW_ID_GPIO},
...
//prize modify by yantaotao for camera end
	...
	/* prize modify by linchong 20210521 for camera i2c channel end */
	{
