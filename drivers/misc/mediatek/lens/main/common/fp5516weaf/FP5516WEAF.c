...
/*
 * FP5516WEAF voice coil motor driver
 *
 *
 */
...
#include "lens_info.h"
/////////////////
//this is for af FP5516WE driver
/////////////////
#define AF_DRVNAME "FP5516WEAF_DRV"
...
static int FP5516WE_Init(void)
{
	int  i4RetValue = 0;
	char puSendCmd[3];
	printk("[FP5516WEAF] FP5516WE_Init - beg\n");
	...
	if (i4RetValue < 0)
	{
	   printk("FP5516WE I2C send 02 failed!! \n");
	}
	mdelay(5);
	puSendCmd[0] = 0x06;
	puSendCmd[1] = 0x0b;   //ZVDD mode
	i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd, 2);
	if (i4RetValue < 0)
	{
	   printk("FP5516WE I2C send 06 failed!! \n");
	}
	puSendCmd[0] = 0x07;
	puSendCmd[1] = 0x01;   //ZVDD mode
	i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd, 2);
    if (i4RetValue < 0) 
    {
        printk("FP5516WE I2C send 07 failed!! \n");
        return -1;
    }
	puSendCmd[0] = 0x08;
	puSendCmd[1] = 0x49;
	...
	if (i4RetValue < 0)
	{
	   printk("FP5516WE I2C send 08 failed!! \n");
	}
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	printk("FP5516WE4AF move [curr] %d [target] %d\n", g_u4CurrPosition, g_u4TargetPosition);
...
/* ////////////////////////////////////////////////////////////// */
long FP5516WEAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int FP5516WEAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	printk("Start\n");
	printk("FP5516WE4AF %s, g_pAF_Opened:%d, AFInf_u4CurrPosition:%d, g_u4CurrPosition:%d ===yantt \n",__func__, *g_pAF_Opened, AFInf_u4CurrPosition, g_u4CurrPosition);
...
int FP5516WEAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int FP5516WEAF_GetFileName(unsigned char *pFileName)
{
