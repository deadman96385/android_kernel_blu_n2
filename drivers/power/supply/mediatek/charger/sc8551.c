...
#define SC8551_DEVID		0x00
//prize add by lipengpeng 20210412 start 
#define SC8551A_DEVID		0x01
//prize add by lipengpeng 20210412 end 
/* Registers */
...
/* Prize HanJiuping added 20210710 for 30W charge start */
extern int is_chg2_exist;
/* Prize HanJiuping added 20210710 for 30W charge end */
enum rt9759_irqidx {
...
static const struct rt9759_dtprop rt9759_dtprops_bool[] = {
	...
	RT9759_DT_VALPROP(tsbusotp_dis, RT9759_REG_CHGCTRL1, 2, 0x04, NULL, 1),
	RT9759_DT_VALPROP(tsbatotp_dis, RT9759_REG_CHGCTRL1, 1, 0x02, NULL, 1),
	...
	RT9759_DT_VALPROP(adc_dis, RT9759_REG_ADCCTRL, 7, 0x80, NULL, 1),
				...
				enum rt9759_type *type)
{
	...
	if (ret < 0)
		return ret;
//prize add by lipengpeng 20210412 start 	
	if ((ret & 0x0f) != RT9759_DEVID && (ret & 0x0f) != SC8551_DEVID && (ret & 0x0f) != SC8551A_DEVID)
		return -ENODEV;
//prize add by lipengpeng 20210412 start 
	*chip_rev = ret;
...
//prize add by lipengpeng 20210412 start 
	if ((chip_rev & 0x0f) == SC8551_DEVID || (chip_rev & 0x0f) == SC8551A_DEVID)
		chip->is_sc8551 = true;
//prize add by lipengpeng 20210412 start 
