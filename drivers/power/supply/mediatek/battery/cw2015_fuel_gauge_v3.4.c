...
#if defined(CONFIG_PROJECT_KOOBEE_K6503Q) || defined(CONFIG_PROJECT_KOOBEE_K6072) || defined(CONFIG_PROJECT_KOOBEE_K605)
...
#elif defined (CONFIG_PROJECT_KOOBEE_K6306)
static unsigned char config_info[SIZE_BATINFO] = {
    #include "profile_BRZH301_K6306Q_3950mAhLT_181121.i"
};
#else//prize add by lipengpeng 20201130 start 
static unsigned char config_info[SIZE_BATINFO] = {
    #include "profile_BRZH301_H9_4800mAh_20201127.i"
};//prize add by lipengpeng 20201130 end
#endif
#endif
...
//prize add by lipengpeng 20190919 start
//		cw_capacity=1;//fucehou keep 1% charge status
//prize add by lipengpeng 20190919 end
...
//		while (counts < 5) {
 //           mdelay(250);
///			printk("lpp---Power 0% ready to shut down,Power 0% ready to shut down,Power 0% ready to shut down\n");
//		   cw_capacity = cw_get_capacity(cw_bat);
//		   counts++;
//		 }
//		set_shutdown_cond(2);
                ...
                union power_supply_propval *val)
{
    ...
    case POWER_SUPPLY_PROP_CAPACITY:
            ...
            break;
//prize add by lipengpeng  20201216 start 	
    case POWER_SUPPLY_PROP_STATUS:   //Chaman charger ic will give a real value
            val->intval = cw_bat->status; 
            break;                 
//prize add by lipengpeng  20201216 end            
...
/* prize add by huarui   add batinfo from dts 20190612 start */
    ...
    cw_bat->capacity = 0; // prize add by lipengpeng 20210121 start 
    cw_bat->voltage = 0;
    cw_bat->status = 0;
